"""Small test-case generator for factory inputs.

Produces a simple JSON case to stdout that can be piped into the factory CLI
for manual testing. This is intentionally small and deterministic.
"""
import json
import sys
